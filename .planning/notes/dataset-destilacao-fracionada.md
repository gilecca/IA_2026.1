---
title: Dataset de destilação fracionada
date: 2026-04-30
context: "Dados coletados do processo de destilação de óleo para classificação com Perceptron."
---

# Dataset de Destilação Fracionada

Os dados referem-se à classificação de amostras de óleo em duas classes de pureza ($C_1 \rightarrow -1$, $C_2 \rightarrow 1$) baseada em três propriedades físico-químicas ($x_1$, $x_2$, $x_3$).

| Padrão | $x_1$ | $x_2$ | $x_3$ | $d$ |
| :--- | :--- | :--- | :--- | :--- |
